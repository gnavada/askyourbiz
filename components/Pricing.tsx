...
const plans = [
  {
    ...
    price: "$497",
    period: "/month",
    description: "Perfect for solo operators and small teams ready to get serious about data.",
    icon: Zap,
    highlight: false,
    features: [
      "1 data source connected (CRM, dialer, or database)",
      "Up to 50 pre-configured query patterns",
  ...
  },
  {
    ...
    price: "$997",
    period: "/month",
    description: "For growing operations with multiple data sources and complex questions.",
    icon: Rocket,
    highlight: true,
    features: [
